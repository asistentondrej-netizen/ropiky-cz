---
title: "Lehké opevnění vzor 36"
code: "LO vz. 36"
category: "lehke"
description: "Starší a jednodušší předchůdce řopíku. Vybudován v letech 1936–1937 jako první sériový typ lehkého objektu. Dnes spíše historická kuriozita — později plně nahrazen vzorem 37."
period: "1936–1937"
builtCount: 864
armament:
  - "Lehký kulomet vz. 26 (7,92 mm)"
  - "Těžký kulomet vz. 24 (7,92 mm) v některých variantách"
  - "Osobní pěchotní zbraně"
order: 10
updated: 2026-04-18
sources:
...
Projekt vzoru 36 byl vypracován **Vojenskotechnickým a leteckým ústavem (VTLÚ)** v Praze. Výstavbu objektů **zadávala jednotlivá zemská vojenská velitelství** — na rozdíl od pozdějšího vzoru 37, jehož výstavbu řídilo ŘOP. Objekty se stavěly v letech **1936–1937**, kdy už se souběžně pracovalo na modernější koncepci vzoru 37.
...
![Půdorysy typů A a B vzoru 36 — s čelnými střílnami](/img/typologie/pudorys-lo-vz-36.svg)
...
Vyprojektovány byly **tři základní typové varianty** (A, B, C) lišící se počtem a orientací střílen, tloušťkou stěn a velikostí posádky:

- **Typ A** — nejčastější varianta, dvě čelní střílny
- **Typ B** — varianta s odlišným uspořádáním střílen
- **Typ C** — větší varianta se třemi střílnami
...
Celkem bylo v letech **1936–1937** vybudováno **přibližně 864 objektů** vzoru 36. Největší koncentrace vznikla na **jižní hranici** s Rakouskem (před anšlusem) — tedy v oblastech hodnocených v polovině 30. let jako ohrožené. Postupně se vzor 36 stavěl i podél severní a severozápadní hranice s Německem, ale zde ho od poloviny 1937 plně nahradil vzor 37.
...
| Parametr | LO vz. 36 | [LO vz. 37 (řopík)](/typologie/lo-vz-37) |
|---|---|---|
| Koncepce | čelná palba | boční palba |
| Typy | 3 (A, B, C) | 5 (A, B, C, D, E) |
| Odolnostní varianty | 2 | 3 provedení (zeslabené, normální, zesílené) |
...
V některých oblastech (zejména **jihomoravské a jihočeské pohraničí**, oblast Znojemska, Valtic, Českých Budějovic) ještě stojí zachovalé objekty a jsou zajímavým dokladem vývojové fáze československé fortifikační koncepce. Mezi nejdostupnější patří objekty v okolí Nových Mlýnů a Mikulovska.

Pro zájemce o historii fortifikace zůstává vzor 36 **klíčovým mezníkem** pochopení vývoje čs. lehkého opevnění — ukazuje, jak rychle se vyvíjely taktické koncepty ve třicátých letech a jak poučení z francouzského, belgického a švýcarského opevnění nasměrovalo čs. armádu k mnohem pokročilejšímu vzoru 37.

## Typy A, B, C — detailní rozlišení

Přestože byla koncepce vzoru 36 brzy nahrazena, všechny **tři typové varianty** zanechaly dodnes viditelnou stopu v krajině:

### Typ A — dvojice čelních střílen

Základní a nejrozšířenější varianta. Dva **lehké kulomety vz. 26** v čelních střílnách, palba vedená směrem k nepříteli v širokém, ale nehlubokém palebném vějíři.

### Typ B

Varianta s odlišným uspořádáním střílen, nasazovaná podle konkrétní terénní situace — typicky na křižovatkách cest a říčních přechodech.

### Typ C — velký třístřílnový

Nejrobustnější varianta s **třemi střílnami**, určená pro dominantní pozice v terénu. Realizována byla jen v malém počtu — dnes jde o nejvzácnější objekty vzoru 36.

## Historie nasazení — zapomenutá linie

Přestože byl vzor 36 **nahrazen modernějším typem**, naprostá většina objektů zůstala v linii a v září 1938 byla **obsazena posádkami** stejně jako řopíky. V některých úsecích tvořily jediný pevnostní prvek, takže v případě války by **první boj svedly právě tyto archaické objekty**.

V **září 1938** byly objekty vzoru 36 obsazovány spolu s okolní linií a vyzbrojeny starší výzbrojí — kulomety vz. 26, případně vz. 24.
...
Za okupace tak byla zničena **velká část objektů vzoru 36** — buď zkušebními střelbami, nebo demolicí. Beton i ocelové výztuhy se pak recyklovaly do německého válečného hospodářství.

## Dochované lokality — kde je vidět

Dnes je vzor 36 **velmi vzácný**. Dochované objekty lze najít především v **jihomoravském pohraničí** (Mikulovsko, Znojemsko, Lednicko-valtický areál) a jednotlivé objekty i v severních Čechách — například u Hostovic nedaleko Ústí nad Labem, kde je objekt dostupný z naučné stezky.

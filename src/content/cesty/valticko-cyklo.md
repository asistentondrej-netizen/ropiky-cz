---
title: "Valticko — 2 cyklovýlety po řopících a UNESCO"
description: "Dva ověřené cyklovýlety z Valtic — 20 km řopíkový okruh přes Rajstnu a 34 km UNESCO okruh do Lednice. Reálné GPS trasy, mapy, fotky, GPX ke stažení."
...
doprava: "kolo"
startPoint:
  nazev: "Prosecco Residence Marko, Úvaly 9, Valtice"
  lat: 48.7451
  lon: 16.6994
endPoint:
  nazev: "Prosecco Residence Marko, Úvaly 9, Valtice"
...
zastavky:
  - nazev: "Zámek Valtice"
    typ: "obec"
    doba_minut: 60
    poznamka: "Hlavní rezidence knížat Liechtensteinů do 1945. Prohlídka 60 min nebo zdarma pohled z nádvoří."
  - nazev: "Kolonáda Rajstna (Reistna)"
    typ: "priroda"
    doba_minut: 30
    poznamka: "Klasicistní dominanta nad Valticemi z roku 1817, výhled na Pálavu a Rakousko."
  - slug: "lo-vz-37-valtice-boriles-jih"
    nazev: "Řopík 5/143/1 (Boří les jih)"
    typ: "pevnost"
    doba_minut: 20
    poznamka: "LO vz. 37 v autentickém lesním prostředí, dobře zachovalý. Klíčový bod — mnoho návštěvníků vidí první řopík právě zde."
  - slug: "lo-vz-37-valtice-pod-dvorem"
  ...
  - nazev: "Apollonův chrám"
    typ: "priroda"
    doba_minut: 15
    poznamka: "Klasicistní salet u Prostředního rybníka, architekt Kornhäusel (1817). Výhled přes rybník na Pálavu (jen Varianta 2)."
  - slug: "lo-vz-37-hlohovec"
  ...
  - nazev: "Zámek Lednice"
    typ: "obec"
    doba_minut: 60
    poznamka: "UNESCO hlavní bod areálu (od 1996), novogotická přestavba 1846–58. Prohlídka Reprezentativních sálů 60 min nebo procházka parkem zdarma (jen Varianta 2)."
  - nazev: "Minaret v Lednickém parku"
    typ: "priroda"
    doba_minut: 30
    poznamka: "60 m vysoká romantická stavba z roku 1802 — nejvyšší mimo Orient. Vyhlídka zdarma, 300 schodů (jen Varianta 2)."
  - nazev: "Národní salon vín (volitelné)"
    typ: "gastro"
    doba_minut: 60
    poznamka: "Degustace v křížové chodbě zámku Valtice — 100 vzorků top českých a moravských vín pod jednou střechou."
tags: ["turistika", "valticko", "lednicko-valtický areál", "cyklo", "jižní morava", "unesco"]
...
Úvaly leží na západní straně Valticka těsně u rakouské hranice, na hraně Lednicko-valtického areálu. Z penzionu je to 5 km k Prostřednímu rybníku, 4 km k valtickému zámku a 10 km k Lednici. **Ideální základna**: vyjedete z tichého prostředí, během 15 minut jste u první památky a na konci dne se vracíte mimo hlavní turistický ruch.
...
- Řopíky jsou **bez vstupu dovnitř** — zvenčí si prohlédnete betonovou mohutnost, postřelování a průzorník
...
**Terén:** převážně asfalt a vinařské stezky, 1–2 úseky po zpevněném povrchu. Převýšení ~150 m.
**Highlights:** UNESCO zámek Lednice, Minaret, Apollonův chrám, 3 řopíky, Rajstna, zámek Valtice.
...
- **Samota Boří dvůr + řopík 8/13/A-160 S** (+6 km) — nejzachovalejší a nejnavštěvovanější řopík Boří lesa, udržovaný spolkem KVH Valtice
- **Charvátská Nová Ves, řopík 5/151/1** (+4 km z Lednice) — u Ladenské cesty, pokud jedete spíš k východu
- **NPR Soutok Dyje–Moravy** — ne stejný den, jen víkendový plán
...
**9:00** Zámek Valtice → **10:30** Rajstna (pěšky 40 min tam a zpět) → **12:00** oběd ve Valticích → **13:30** auto do Hlohovce, řopík 6/54 + Apollonův chrám → **15:00** Lednice (zámek + Minaret, 2 h) → **17:30** Národní salon vín Valtice → **20:00** návrat. Celkem 8 h, 30 km autem v pohodě.

## Kdy jet

| Období | Hodnocení |
|---|---|
| **Duben — červen** | ★★★★★ Nejlepší. Kvetou louky, vinná réva se probouzí, méně turistů. |
...
- *Trasa 2:* Lednice u zámku (víc variant, ale dražší), nebo svačina u Apollonova chrámu

**Vinné sklepy:** Národní salon vín ČR (Valtice, zámek, křížová chodba) — 100 vzorků, benchmark kvality. Vinařské sklepy v Úvalech — autentická místní scéna, vstřícné ceny.

**Doprava do Úval:** Autem z Brna D2 → Břeclav exit → Valtice → Úvaly (60 km, 50 min). Z Prahy D1 → Brno → D2 → Břeclav (250 km, 3 h). Vlakem Brno → Břeclav (40 min) → Valtice (lokálka, 10 min) → taxi do Úval.

## Srovnání s jinými destinacemi
...
- [Stezka Betonová hranice](/cesty/stezka-betonova-hranice) — hustá linie u Králík
- [Stezka Darkovičky](/cesty/stezka-darkovicky) — rodinná stezka TO na severní Moravě

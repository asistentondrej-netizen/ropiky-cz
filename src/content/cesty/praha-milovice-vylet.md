...
zastavky:
  ...
  - nazev: Oběd v Milovicích (restaurace U Tanku)
    typ: gastro
    doba_minut: 60
    poznamka: Tematická restaurace v blízkosti muzea, domácí kuchyně.
  - nazev: Mladá Boleslav — Muzeum Škoda
    typ: muzeum
    doba_minut: 120
    poznamka: Kombinace s návštěvou automobilového muzea (30 km od Milovic). Otevřeno celoročně.
  - nazev: Park Milovice (vojenský prostor)
    typ: priroda
    doba_minut: 60
    poznamka: Procházka bývalým vojenským prostorem, stáda divokých koní, stepní ekosystém.
tags:
  - praha
  - milovice
  - rodinny-vylet
...
**09:00 — Odjezd z Prahy** (40 min autem, 45 min vlakem z Masarykova nádraží, linky 070/072).
...
- Sovětské i české tanky (T-34, T-55, T-72).
- Obrněné transportéry (BVP, OT-64, OT-810).
- Letadla (MiG-21, Mi-4, L-29).
- Dělostřelectvo, rakety, radary.
...
**14:00–16:00 — Variabilní program** (vyberte jednu z možností):

### A) Park Milovice — divocí koně
...
## Speciální akce Milovic

- **Letní tábor** (červenec–srpen) — historická tematika, pro děti 10–15 let.
- **Sudetská krize** (září) — komentované prohlídky, rekonstrukce událostí 1938.
- **Dětský den** (červen) — jízdy na historické technice, ukázky bojových technik.

Aktuální program: [muzeum-milovice.cz](https://www.muzeum-milovice.cz).

## Výhody Milovic

- **Celoroční otevření** — na rozdíl od sezónních expozic v pohraničí.
- **Teplota uvnitř** — 18 °C (pohodlné i v zimě).
- **Parkování zdarma** u muzea.
- **Ideální rodinný cíl** — 180 minut programu, kombinace interiér + exteriér.
- **Dopravní dostupnost** — vlakem z Prahy 45 minut.

## Pro koho je Milovice ideální

- **Pražané a středočeši**, kteří nechtějí cestovat do pohraničí.
- **Rodiny s dětmi 6+ let** — vstup do tématu bez nároku na fyzickou kondici.
- **Školní výlety** — skupinové slevy, vzdělávací program.
- **Celoročně** — ideální mimosezónní výlet (listopad–březen), kdy jsou pohraniční muzea zavřená.

## Další kroky — rozšíření tématu

Pokud vás Milovice zaujalo, dalším krokem je **návštěva skutečného pohraničního muzea**:

1. **[Okruh po Ostravsku](/cesty/okruh-po-ostravsku)** — Darkovičky (celoročně, 4 hodiny z Prahy).
2. **[Víkend v Králíkách](/cesty/vikend-v-kralikach)** — tvrze Bouda a Hanička (dvoudenní dovolená).
3. **[Trutnovsko a Adršpach](/cesty/trutnovsko-adrspach)** — kombinace s přírodou.

## Kontakt

- Muzeum čs. armády Milovice: [muzeum-milovice.cz](https://www.muzeum-milovice.cz)
- Adresa: Milovice, bývalý vojenský prostor
- Dopravní informace: IDOS (vlak Praha–Milovice)

...
description: "Naučná stezka okolo dělostřelecké tvrze Dobrošov u Náchoda — 8 km okruh, 12 zastavení. Ideální jednodenní výlet z Náchoda nebo Hradce Králové."
...
doprava: "mhd-chuze"
startPoint:
  nazev: "Vojenské muzeum Náchod"
  lat: 50.4158
  lon: 16.1631
endPoint:
  nazev: "Vojenské muzeum Náchod (návrat)"
  lat: 50.4158
  lon: 16.1631
zastavky:
  - nazev: "Vojenské muzeum Náchod"
    typ: "muzeum"
    doba_minut: 60
    poznamka: "Výchozí bod — menší expozice pěšího pluku 18. ČSR a událostí září 1938 v Náchodsku. Vstupné 50 Kč, otevřeno po–pá 9:00–16:00."
  - slug: "n-s-75-zahrada"
    nazev: 'Pěchotní srub N-S 75 „Závoz"'
    typ: "pevnost"
    doba_minut: 20
    poznamka: "První bunkrový objekt na trase, 1 km od muzea. Externě prohlížitelný, dva pancéřové zvony v originálním stavu."
  ...
  - nazev: 'Pozorovatelna „Skalka"'
    typ: "priroda"
    doba_minut: 20
    poznamka: "Přírodní vyhlídka 250 m. n. m. s panoramatem do Polska a Kladské kotliny — strategický bod, odkud čs. armáda hlídala německé pohyby."
  - nazev: 'Pěchotní srub N-S 76 „Skalka"'
    typ: "pevnost"
    doba_minut: 15
    poznamka: "Sousední objekt integrovaný do scenérie skály — externě přístupný, vchod uzavřen. Ukázka maskování krycími barvami."
  - slug: "tvrz-dobrosov"
  ...
  - nazev: "Tvrz Dobrošov — Pěchotní srub č. 1"
    typ: "pevnost"
    doba_minut: 20
    poznamka: "Externě navštívitelná součást tvrze — nedokončený srub na konci roku 1938. Betonové stěny bez pancéřového vybavení."
  - nazev: "Tvrz Dobrošov — Pěchotní srub č. 2"
    typ: "pevnost"
    doba_minut: 20
    poznamka: "Druhý nedokončený srub tvrze. Tabule ukazuje plán dostavby, jak by měla tvrz vypadat do roku 1942."
  ...
  - slug: "n-s-80-jirasek"
    nazev: 'Pěchotní srub N-S 80 „Jirásek"'
    typ: "pevnost"
    doba_minut: 25
    poznamka: "Závěrečný betonový objekt na trase. Izolovaný TO chránící křižovatku silnic z Náchoda do Police nad Metují a Trutnova. Externě prohlížitelný."
  - nazev: "Návrat do Vojenského muzea"
    typ: "muzeum"
    doba_minut: 10
...
**Vhodné:** pěší turisté všech věkových kategorií od 10 let, rodiny s dětmi (zastavení mají interaktivní prvky), školní výlety (Klub vojenské historie nabízí výklad ve speciálním tarifu), fotografy (panoramatický výhled u Skalky).

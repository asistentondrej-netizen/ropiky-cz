...
zastavky:
  ...
  - nazev: Hřeben Orlických hor (procházka)
    typ: priroda
    doba_minut: 90
    poznamka: Červená značka po hřebeni, panoramatický výhled k polské hranici.
  - nazev: Rokytnice v Orlických horách (centrum)
    typ: obec
    doba_minut: 45
    poznamka: Historické centrum, kostel sv. Ondřeje, muzeum Orlických hor.
tags:
  - orlicke-hory
  - hanicka
  - kahan
...
**17:30 — Návrat do Rokytnice,** možnost návštěvy historického centra (kostel sv. Ondřeje, muzeum Orlických hor).
...
Kombinujte s [Víkendem v Králíkách](/cesty/vikend-v-kralikach) — druhý den tvrz Bouda + K-S 14 Cihelna (50 km jižně). **Tvrze Bouda a Hanička spolu tvoří nejsilnější fortifikační duo v ČR.**

---
title: Trutnovsko a Adršpach — T-S 19 „Turov" a přírodní rezervace
description: Kombinace fortifikačního muzea Pevnost Hronov (pěchotní srub T-S 19) s přírodními skvosty Broumovska — Adršpašské skály a Broumovské stěny. Ideální pro návštěvníky, kteří chtějí historii i přírodu v jednom dni.
...
zastavky:
  - slug: t-s-19-turov
    nazev: T-S 19 „Turov" — muzeum Pevnost Hronov
    typ: pevnost
    doba_minut: 60
    poznamka: Oboustranný srub III. odolnosti s panoramatickým výhledem. Spravuje Klub vojenské historie Náchod.
  - nazev: Oběd v Hronově
    typ: gastro
    doba_minut: 60
    poznamka: Restaurace v centru Hronova (5 min od T-S 19).
  ...
  - nazev: Broumovské stěny (vyhlídka Junácká)
    typ: priroda
    doba_minut: 90
    poznamka: Panoramatický výhled na Polsko a fortifikační linii Trutnovska.
tags:
  - trutnovsko
  - adrspach
  - broumovsko
...
**08:30 — Příjezd do Hronova** (z Hradce Králové 60 min, z Prahy 2 hodiny).
...
- **Turistická obuv** (skály, schody).
- **Svetr** (v T-S 19 celoročně 10 °C).
- **Fotoaparát** (Adršpach patří k nejfotogeničtějším místům v ČR).
- **Rezervaci na Adršpach** (červenec–srpen povinná).

## Sezónní tipy

- **Květen–červen:** kvetoucí rododendrony v Adršpachu, nízká návštěvnost.
- **Září–říjen:** podzimní barvy, nízké teploty ideální pro fotografy.
- **Červenec–srpen:** přeplněno, rezervace Adršpachu nutná, doporučuji víkend mimo špičku.
- **Zima:** T-S 19 zavřený, Adršpach otevřený (ledopády v propastech).

## Dopravní dostupnost

- **Auto:** Hronov z Prahy 2:00, z Hradce Králové 1:00, z Pardubic 1:30.
- **Vlak:** Hronov (linky 026 + 028), z Prahy cca 3 hodiny. Odtud taxi nebo kolo k T-S 19 (8 km).
- **Kolo:** oblast je propojená sítí cyklostezek Broumovska.

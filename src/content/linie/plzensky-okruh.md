...
bounds:
  ...
  east: 13.60
  west: 12.05
tags: ["chebsko", "plzensko", "asky-vybezek", "lo-vz-37", "ropik"]
sources:
  - "Aron L.: Opevnění západních Čech"
  - "KVH Cheb — terénní průzkumy"
updated: 2026-04-21
---
...
- **Aš** — severní cíp, nejexponovanější pozice
...
Chebsko bylo v roce 1938 **z 90 % etnicky německé** a podle mnichovské dohody bylo **první odevzdávané území** (1.–5. října 1938). Většina místních obyvatel přijímala Wehrmacht jako **osvoboditele** — v kontrastu s československými posádkami, které často odcházely za plivání od místních.

Po roce 1945 bylo Chebsko **masivně vysídleno** (německá menšina odsunuta) a řada řopíků se ocitla **uprostřed opuštěných vesnic**, které po odsunu zanikly. Proto je zde dnes tak výjimečná kombinace: **zaniklé obce + řopíky v krajině** — unikátní kulisa pro fotografii a historickou reflexi.

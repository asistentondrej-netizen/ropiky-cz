...
bounds:
  ...
  east: 17.20
  west: 15.70
tags: ["jizni-morava", "znojemsko", "mikulovsko", "lo-vz-37", "ropik"]
sources:
  - "Lakosil J.: Lehké opevnění jižní Moravy"
  - "Muzeum čs. opevnění Šatov"
  - "KVH Šatov — terénní průzkumy"
updated: 2026-04-21
---
...
Od **Slavonic** přes **Jaroslavice**, **Znojmo**, **Šatov**, **Mikulov**, **Sedlec u Mikulova** a **Pohansko** po hranici s okresem Hodonín. Většina objektů je typu **LO vz. 37 typ A** (boční palba) — v otevřené krajině u vinic, polí a říčních koryt.
...
Po mnichovské dohodě byla linie předána **1.–10. října 1938**. Jen několik dní starý beton některých řopíků byl **pořád ještě mokrý uvnitř** — Wehrmacht si pochvaloval, že tak získal „objekty ve výrobním stavu". Část řopíků byla Wehrmachtem **použita jako cvičné cíle** pro dělostřelectvo v letech 1939–1940 — to vysvětluje řadu zničených nebo poškozených objektů podél linie.

## Specifikum — mikulovská linie

**V okolí Mikulova** leží dnes zvlášť hustá síť volně přístupných řopíků. **Asi 60 objektů** v okruhu 5 km od centra města — mnohé zachovalé, některé s grafitti, některé uzavřené. **Ideální terén pro pěší nebo cyklo okruh** v moravském vinařském regionu.
...
Ideální kombinace s **ochutnávkou moravského vína** (Šatov, Vrbovec, Znojmo) — jižní Morava je perfektní **fortifikačně-enogastronomická destinace**.
